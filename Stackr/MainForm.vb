...
''			
''			Dim Himl As IntPtr
''			Dim iLarge As IntPtr
''			Dim iSmall As IntPtr
''	
...
''			
''	
''	     	Himl = SHGetFileInfo(F.FullName, 0, ShInfo, _
''                 Marshal.SizeOf(ShInfo), _
''                 SHGFI_ICONLOCATION or SHGFI_SYSICONINDEX Or ILC_COLOR32 )
''	     	
''	     	'MsgBox(ShInfo.szDisplayName.ToString & ShInfo.iIcon.ToString)
''	     	
''	     	'Dim myIcon As System.Drawing.Icon
''	     	
''	     	'If Himl.ToString IsNot "" Then
''	     	
''	     	'MsgBox(ShInfo.iIcon)
''	     	
''	     	'Dim Ex As IExtractIcon
''	     	
''	     	'Ex.Extract(Himl,ShInfo.iIcon,iLarge,iSmall,32)
''	     	
''	     		hInst = Marshal.GetHINSTANCE(Me.GetType().Module)
''	     		ShInfo.hIcon = ExtractIcon(hInst,F.FullName,ShInfo.iIcon)
''	     			
''	     			ImageList_GetIcon(Himl, ShInfo.iIcon, ILD_TRANSPARENT)
''	     		'MsgBox(hIcon.ToString)
''	     		 'Ex.Extract(Himl, ShInfo.iIcon,iLarge,iSmall,32)
''	     		 newIcon = System.Drawing.Icon.FromHandle(ShInfo.hIcon)
'	     		
'	     	'End If
